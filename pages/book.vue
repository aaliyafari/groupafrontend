<template>
<div class="bg-[url(https://img.freepik.com/premium-photo/book-stack-library-room-blurred-bookshelf-background_42691-514.jpg?w=1300)]">
    <title>
        Book Management
    </title>
    <h1 class=" text-center font-extrabold text-5xl mt-4">Book Management</h1>
    <hr class="mt-5 border-1 border-black">

    <div class="sm border-4 bg-blue-100 mr-60 ml-60 p-4 border-solid border-black rounded-md mt-6 ">
        <form action="" name="myForm" onsubmit="return validateForm()" method="post">
            ...
            <div class="p-1  mt-6">
                <button class="ml-16 border-2 font-bold mr-16 rounded-md bg-black text-blue-500 hover:bg-black p-2 text-center" type="submit" @click="addpro">Add Book</button>
