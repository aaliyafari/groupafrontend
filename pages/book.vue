      ...
      <div>
        <div >
          <div class="text-center">
            ...
            <table>
              <div class="px-2">
              <label class="font-bold">Database Error</label><hr/><br/>
              ...
              <label>Book ISBN Number Error___________</label><br/>
                ...
                <input type="text"  id="book_author" name="book_author" placeholder="" v-model="formData.book_author" @change="validationAuthor"><br/>
                <span class="text-sm text-red-500" v-for="error in v$.book_author.$errors" :key="error.$uid">{{error.$message}}</span>
                <br><br>
                
                <label for="book_price">Book Price:- </label>
                <input type="number"  id="book_price" name="book_price" placeholder="" v-model="formData.book_price" @change="validationPrice"><br/>
                ...
                <br/><br/> -->
                 <!-- <select name="book_category" id="book_category" v-model="formData.book_category">
...
async function  getalldata(){
    state.items = await $fetch("http://localhost:3001/book");
}
// 2nd part
